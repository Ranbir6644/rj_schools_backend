...
router.get("/attendance-graph", getAttendanceGraphData);       // Graph data with filters- Monthwise
router.get("/daily-attendance", getDailyAttendanceGraphData);  // Daily graph data - Datewise
...
router.get("/record", getDashboardRecord);                     // Attendance + fines record (admin/teacher)
